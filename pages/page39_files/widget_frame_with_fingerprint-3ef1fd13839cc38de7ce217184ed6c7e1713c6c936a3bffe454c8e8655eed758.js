...
var o = n.addEventListener ? "addEventListener" :"attachEvent", a = n.addEventListener ? "removeEventListener" :"detachEvent", c = n.addEventListener ? "" :"on", s = !1, u = !0, l = n.documentElement, d = [];
if (e.extend({
...
return s ? void e.apply(n) :void d.push(e);
}, n.createEventObject && l.doScroll) {
try {
u = !t.frameElement;
} catch (f) {}
u && i();
...
i = null);
var l = t.xhr;
l.open(a.toUpperCase(), o, r.async, r.user, r.password), r.user && "withCredentials" in l && (l.withCredentials = !0), 
l.onreadystatechange = e.bind(t.onStateChange, t);
for (var d in t.headers) try {
l.setRequestHeader(d, t.headers[d]);
} catch (f) {
r.exception.apply(t, [ d, t.headers[d] ]);
}
return l.send(i), r.async || t.onStateChange(), t;
},
cancel:function() {
var e = this;
...
var l = !1;
if (i[s] && i[s][n]) for (var d = 0; d < i[s][n].length; d++) if (i[s][n][d].win === c) {
i[s][n][d].handler(s, a, t), l = !0;
break;
}
if (!l && i["*"] && i["*"][n]) for (var d = 0; d < i["*"][n].length; d++) if (i["*"][n][d].win === c) {
i["*"][n][d].handler(s, a, t);
break;
}
...
d[e].error("timeout_error", r), delete d[e], delete o[e];
}
}, t);
}, w = function(e, t, r) {
...
if (r.id && t) {
if (l[t]) {
var s = h(r.id, e, r.callbacks ? r.callbacks :[]);
f[r.id] = {};
try {
if (r.callbacks && n(r.callbacks) && r.callbacks.length > 0) for (var u = 0; u < r.callbacks.length; u++) {
for (var p = r.callbacks[u], g = r.params, m = p.split("/"), w = 0; w < m.length - 1; w++) {
var y = m[w];
...
var v = l[t](s, r.params);
s.delayReturn() || s.completed() || s.complete(v);
} catch (c) {
...
} else r.id && r.callback ? d[r.id] && d[r.id].callbacks && d[r.id].callbacks[r.callback] ? d[r.id].callbacks[r.callback](r.params) :a("ignoring invalid callback, id:" + r.id + " (" + r.callback + ")") :r.id ? d[r.id] ? (r.error ? d[r.id].error(r.error, r.message) :void 0 !== r.result ? d[r.id].success(r.result) :d[r.id].success(), 
delete d[r.id], delete o[r.id]) :a("ignoring invalid response: " + r.id) :t && l[t] && l[t]({
origin:e
}, r.params);
};
e(i.window, i.origin, "string" == typeof i.scope ? i.scope :"", w);
var y = function(e) {
...
unbind:function(e) {
if (l[e]) {
if (!delete l[e]) throw new Error("can't delete method: " + e);
return !0;
}
return !1;
},
...
if (l[e]) throw new Error("method '" + e + "' is already bound!");
return l[e] = t, this;
},
call:function(e) {
...
n.length && (c.callbacks = n), e.timeout && m(r, e.timeout, y(e.method)), d[r] = {
callbacks:t,
error:e.error,
success:e.success
}, o[r] = w, r++, v(c);
...
destroy:function() {
t(i.window, i.origin, "string" == typeof i.scope ? i.scope :""), window.removeEventListener ? window.removeEventListener("message", w, !1) :window.detachEvent && window.detachEvent("onmessage", w), 
p = !1, l = {}, f = {}, d = {}, i.origin = null, g = [], a("channel destroyed"), 
u = "";
}
};
...
l() && A && (A = A.indexOf("staging.") > 0 ? "//w-staging.ahalogy.com" :A.indexOf(".dev") > 0 ? "//w.ahalogy.dev" :"//w.ahalogy.com");
}
return A;
}
function p() {
var e = f();
return _ = e.indexOf("//w.ahalogy.dev") > 0 ? "//v1.ahalogy.dev" :e.indexOf("staging.") > 0 ? "//v1.staging.ahalogy.com" :"//v1.ahalogy.com";
}
function g(e, t) {
...
} else i = "object" == typeof e ? y(e, r) :r + "=" + encodeURIComponent(e);
null !== e && n.push(i);
}), n.join("&");
}
function v(n, r, i, o, a, c, s) {
...
var A, _, O = (t.console, !1), C = t.AhalogyWidgetLog = t.AhalogyWidgetLog || [], j = function() {
...
return e.log = j, e.logError = P, e.isLegacyMode = l, e.getAhalogyBaseUrl = f, e.getAhalogyLegacyBaseUrl = p, 
e.insertAfter = g, e.setNodeStyle = h, e.hasClass = x, e.each = m, e.isArray = w, 
e.toQueryString = y, e.trackEvent = v, e.getA = k, e.exceptionOccurred = E, e.debugExceptions = s, 
e.isMobile = N, e.mergeObjects = S, e.quiet = c, e;
}(window.AhalogyWidget || {}, window, document, snack, window._ahalogy || window._pingage, Fingerprint), 
window.AhalogyWidget = function(e, t, n, r, i) {
"use strict";
function o(t) {
e.log("Ahalogy Widget Frame af50181"), x = t, j = b("loaded_at"), v(), p(), m(), 
w(), a(), c(), s();
}
function a() {
x.wedging_enabled && x.site_client && (e.log("Starting pin wedging."), k.notify({
method:"wedge",
params:{
client_id:x.site_client.id
}
}));
}
function c() {
var e = document.getElementById("widget_page_test");
if (e) {
var t = {
top:"0",
bottom:"0",
...
function s() {
E = document.getElementById("engagement-container"), S = document.getElementById("engagement"), 
E && u();
}
function u() {
C || (C = !0, n.wrap("[data-action],[data-track]").each(function(e, t) {
var r = {
node:e,
event:"click"
};
n.listener(r, f);
}), e.trackEvent("View", null, x, {
view_timing:"immediate"
}, j), g("View", null), l(), O && O());
}
function l(e) {
var t = {
...
switch (S.getAttribute("data-style")) {
case "modal":
n = !0;
break;

case "top":
t.bottom = null, t.height = S.getAttribute("data-height");
break;

case "bottom":
t.top = null, t.height = S.getAttribute("data-height");
break;

case "left":
t.right = null, t.width = S.getAttribute("data-width");
break;

case "right":
t.left = null, t.width = S.getAttribute("data-width");
break;

case "corner":
switch (S.getAttribute("data-corner")) {
case "tl":
t.bottom = t.right = null;
break;

case "tr":
t.bottom = t.left = null;
break;
...
t.width = S.getAttribute("data-width"), t.height = S.getAttribute("data-height");
break;
...
function d() {
k.notify({
method:"makeFrameHidden"
}), e.trackEvent("Close", null, x, null, j), g("Close", null);
}
function f(t) {
if (!t.currentTarget) throw new Error("event.currentTarget missing");
var r = t.currentTarget.getAttribute("data-track");
r && window.setTimeout(function() {
e.trackEvent("Click", r, x, null, j), g("Click", r);
}, 1);
var i = t.target.getAttribute("data-action");
switch (i) {
case "open_url":
n.preventDefault(t), k.notify({
method:"openUrl",
params:{
url:x.pin.url
}
...
var o = function() {
d();
}, a = S.getAttribute("data-kill-delay");
a ? window.setTimeout(o, a) :o(), n.preventDefault(t);
break;

default:
e.log("Unhandled Click Event", t, "Action", i);
}
n.stopPropagation(t);
}
function p() {
window.setTimeout(function() {
"undefined" != typeof r && (x.site_client && x.site_client.ga_id && (A = !0, r("create", x.site_client.ga_id, {
name:"siteClientTracker"
})), x.client && x.client.ga_id && (x.site_client && x.client.ga_id == x.site_client.ga_id || (_ = !0, 
r("create", x.client.ga_id, {
name:"clientTracker"
}))));
}, 1);
}
...
function h(e, t) {
window.setTimeout(function() {
"undefined" != typeof r && (r(e, t), A && r("siteClientTracker." + e, t), _ && r("clientTracker." + e, t));
}, 2);
}
function m(e) {
h("set", {
dimension1:window.devicePixelRatio
}), h("send", {
hitType:"pageview",
page:e
});
...
function w(t) {
e.trackEvent("Impression", null, x, null, j);
}
function y(e) {
O = e;
}
...
var x, k, E, S, A, _, O, C = !1, j = null;
return e.Frame = {
init:o,
closeEngagement:d,
onEngagementStarted:y
}, e;
}(window.AhalogyWidget || {}, Channel, snack, window.ga, window.console);