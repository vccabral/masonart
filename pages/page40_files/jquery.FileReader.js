...
(function( $ ){
	...
	if (window.FileReader) {
		...
		console.info('do not use plugin');
	...
	*/
	$.fn.fileReader = function( options ) {  
		if(hasFlash) {
			...
			console.info('stop plugin, no flash');
		}
		
		console.info('use plugin');
	...
	window.FileAPIProxy = {
		...
		init: function(o) {
			...
			swfobject.embedSWF(o.filereader, o.id, '100%', '100%', '10', o.expressInstall, {debugMode: o.debugMode ? true : ''}, {'wmode':'transparent','allowScriptAccess':'sameDomain'}, {}, function(e) {
				...
				if (self.ready) {
					readyCallbacks.fire();
					//console.info('flash object is ready');
				} else {
					//console.info('flash object not ready');
				}
